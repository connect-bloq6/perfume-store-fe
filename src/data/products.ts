...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'La Femme Rose is an exquisite feminine fragrance that embodies grace and sophistication. A delicate symphony of rose petals, soft peony, and warm sandalwood creates an unforgettable aura of timeless beauty.',
    notes: {
  ...
  },
  {
    ...
    notes: {
      top: 'Honey, Rum, Mandarin',
      heart: 'Orchid, Heliotrope, Jasmine',
      base: 'Suede, Vanilla, Vetiver',
    },
    longevity: '10-12 hours',
  ...
  },
  {
    ...
    volumes: [
      { size: '30ml', price: 235 },
      { size: '50ml', price: 310 },
      { size: '100ml', price: 455 },
      { size: '150ml', price: 590 },
    ],
    colors: [
    ...
    notes: {
      top: 'Night Jasmine, Peach, Green Notes',
      heart: 'Tuberose, Gardenia, Ylang-Ylang',
